...
python feat_extract.py --in-dataset waterbird  --out-datasets SVHN lsun isun placesbg --name resnet18  --model-arch resnet18
python run_cifar.py --in-dataset waterbird  --out-datasets SVHN lsun isun placesbg --name resnet18  --model-arch resnet18
